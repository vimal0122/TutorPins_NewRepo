...
namespace TutorPins_Client.Extensions
{
    public static class SessionStorageServiceExtension
    {
        public static async Task SaveItemEncryptedAsync(this ISessionStorageService sessionStorageService, string key, Task item)
        {
